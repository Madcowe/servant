...
impl Default for ServoShellPreferences {
    fn default() -> Self {
        Self {
            ...
            headless: false,
            homepage: "ant://56fd2c26139fa0e078838d963c6b14054ad913f2fdff0d5b88039292dbe41f03/index.html".into(),
...
struct CmdArgs {
    ...
    #[bpaf(positional("URL"), fallback(String::from("ant://56fd2c26139fa0e078838d963c6b14054ad913f2fdff0d5b88039292dbe41f03/index.html")))]
    url: String,
}
